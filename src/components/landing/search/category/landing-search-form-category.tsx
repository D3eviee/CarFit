...
import { LandingSearchFormCategoryDropdown } from "./landing-search-form-category-dropdown";
...
export const LandingSearchFormCategory = ({categoryState, setCategoryState}: LandingSearchCategoryProps) => {
  ...
  return (
    <div className="relative w-full"> 
        ...
        <LandingSearchFormCategoryDropdown
