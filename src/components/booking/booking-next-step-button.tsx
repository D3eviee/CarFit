  ...
  return (
    <>
        <button 
            ...
            onClick={nextStepFn}
            className={cn("w-full text-center font-normal text-base rounded-xl md:w-full py-2.5 bg-linear-to-b from-[#313131] to-[#141414] text-[#FFFFFF] hover:bg-[#333] hover:cursor-pointer active:scale-xs duration-150 transition-all", 
                isButtonDisabled() && "bg-linear-to-b from-[#D4D4D4] to-[#D4D4D4]")}
        >
            Dalej
        </button>
    </>
