...
export const BookingStatusBarMobile = ({services, bookingStep, setNextBookingStep}:BookingStatusBarMobileProps) => {
  ...
  return (
    ...
    <div className="w-full sticky bottom-0 left-0 lg:hidden bg-[#F2F2F7] shadow-inner-glass px-3 py-1.5">
