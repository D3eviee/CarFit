...
export default function DasboardProfileDeleteAccountModal(){
  ...
  return(
   <div className="flex flex-col px-8 pt-6 pb-3 bg-white backdrop-blur-[3px] ring-1 ring-white inset-shadow-white rounded-2xl max-w-[350px] text-black space-y-5">
      <p className="px-2 text-[#191919] text-small text-pretty text-left font-normal">Czy na pewno usunąć konto? Czynność ta jest nieodwracalna</p>
