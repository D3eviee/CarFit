...
export const DashboardServicesDeleteCategoryModal = ({categoryId}: {categoryId:string}) => {
  ...
  const { mutate: deleteCategoryMutation, isPending:deleteCategoryMutationIsPending } = useMutation({
  ...
  return(
    <div className="w-[360px] flex flex-col px-3 pt-5 pb-3 bg-white ring-1 ring-white inset-shadow-white rounded-2xl text-black space-y-5">
      <p className="px-1 text-[#191919] text-middle text-pretty text-left font-normal tracking-tighter">Czy na pewno usunąć kategorię?</p>
